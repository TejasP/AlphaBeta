            ...
            <ul class="right">
              ...
              <li class="has-dropdown">
				...
				if($isUserLoggedIn === 'false'){ ?>
                  ...
                  <li>
                    <a data-reveal-id="myModal" href="<?php echo $this->Html->url(array('controller'=>'registration', 'action'=>'register'))?>" data-reveal-ajax="true" onclick="javascript:callRegisterModal();">Register</a>
                  </li>
              	<?php }else{?>
              	  <li>
