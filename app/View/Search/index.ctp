				...
				<div class="tabs-content">
 					...
 					<table class="responsive">
					  ...
					  <tbody>
					      ...
					      <td><a href="#" id="quote-<?php echo ($results[$i][0]['medicines_header']['medicine_id']) ?>" class="button tiny radius" onClick="javascript:callBook('<?php echo $results[$i][0]['medicines_header']['medicine_id'] ?>','1','1');">Choose</a></td>
					   	  </tr>
